# Dictionary for nob — fin

This repository contains source files for a dictionary from Norwegian Bokmål to Finnish. The content is licensed under the CC-BY-4.0 license.
